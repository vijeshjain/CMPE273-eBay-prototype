 ...
 exports.listProducts = function(req, res){
	...
	if(typeof(user)=="undefined")
		...
		var categories=user.category ;
	 	var subCat=user.subCategories;
	 	mysql.fetchData(function(err,rows){
	 		if(!err)
	 		{


	 			ejs.renderFile('./views/showProducts.ejs', {rows: rows, category: categories,subCategories:subCat }, function(err, result)
	 			{
	 				if(!err)
	 				{
	 					console.log("In Product.ejs *******");
